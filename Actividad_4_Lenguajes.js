...
const languageStrings = {
  ...
  es:{
    translation: {
      ...
      CONVERT_PESO_EURO: 'La conversión de %s pesos equivale a %s euros.',
      CONVERT_EURO_DOLAR: 'La conversión de %s euros equivale a %s dolares.',
      CONVERT_PESO_DOLAR: 'La conversión de %s pesos equivale a %s dolares.',
      CONVERT_DOLAR_PESO: 'La conversión de %s dolares equivale a %s pesos.',
      CONVERT_EURO_PESO: 'La conversión de %s euros equivale a %s pesos.',
      CONVERT_DOLAR_EURO: 'La conversión de %s dolares equivale a %s euros.',
...
// Este interceptor de solicitudes registrará todas las solicitudes entrantes a esta lambda
...
// Este interceptor de solicitudes vinculará una función de traducción 't' a los atributos de solicitud.
